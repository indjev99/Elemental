...
\item \chance \ -- The most unusual element. Whenever its value is needed, its die is rerolled. Cards that affect the values of dice cannot affect it (except for cards which explicitly specify the opposite.)
\end{itemize}
...
&
\card{Optimization Lord}{Action}{ \small Permanently remove up to 3 cards from your hand, this card can also be one of the 3.}{\threecost}{imgs/optimization_lord.png}
&
\card{Optimization God}{Action}{ \small Permanently remove up to 4 cards from your hand or discard pile, this card can also be one of the 4.}{\fourcost}{imgs/optimization_god.png}
&
...
&
\card{Express Shipping}{Passive}{Whenever you buy a card, you may pay 5 gold for it to go into your hand (instead of your draw pile).}{\twocost}{imgs/express_shipping.png}
&
