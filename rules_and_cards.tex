...
\begin{itemize}
\item Attack -- ``Deal X damage'' cards (i.e. reduce the opponent's HP). They all scale with one or two of \chance, \fire, \earth, \water \ and \magic. Attacks that scale with \water \ deal damage to both players.
...
\item Shield -- ``Shield X against damage that scales with Y'' cards. They reduce incoming damage.
...
\item Trash -- ``Trash X cards from ...'' cards. Trash a card means removing it from one's deck and moving it to the trash pile. Useful for removing bad cards.
...
A player's hand, face down cards, discard pile and discards are private information, i.e. only they may see them. The laid out shop, the shop's discard pile, the trash pile, a player's played cards, bought cards, trashed cards, gold, HP, mana and all counts (e.g. number of cards in hand) are all public information, i.e. everyone can see them. All draw piles are hidden information, i.e. nobody can see them.
...
\item ``Wish'' (``Buy any unowned card for free and then shuffle the shop's draw pile; trash this card after 3 uses.'') can target cards in the shop and its draw and discard piles. The chosen card is public information.
...
&
\card{Heavy Rain}{Spell}{ \small Deal \water \ damage to your opponent and yourself; opponent shields affect self damage.}{\draft}{imgs/heavy_rain.png}
&
...
&
\card{Torrential Rainstorm}{Spell}{ \small Deal 2\hspace{1pt}$\times$\hspace{1pt}\water \ damage to your opponent and yourself; opponent shields affect self damage.}{\threecost}{imgs/torrential_rainstorm.png}
&
...
&
\card{Scalding Fog}{Spell}{ \small Deal \water\hspace{1pt}$+$\hspace{1pt}\fire \ damage to your opponent and yourself; opponent shields affect self damage.}{\threecost}{imgs/scalding_fog.png}
&
\card{Devastating Mudslide}{Spell}{ \small Deal \water\hspace{1pt}$+$\hspace{1pt}\earth \ damage to your opponent and yourself; opponent shields affect self damage.}{\threecost}{imgs/devastating_mudslide.png}
&
\card{Wild Seas}{Spell}{ \small Deal \water\hspace{1pt}$+$\hspace{1pt}\chance \ damage to your opponent and yourself; opponent shields affect self damage.}{\threecost}{imgs/wild_seas.png}
&
...
&
\card{Biblical Flood}{Spell}{ \small Deal \water\hspace{1pt}$\times$\hspace{1pt}\magic \ damage to your opponent and yourself; opponent shields affect self damage.}{\fourcost}{imgs/biblical_flood.png}
&
...
\card{Water Reservoirs}{Blessing}{ \small Shield \water \ against damage that scales with \fire \ until the end of your opponent's turn.}{\onecost}{imgs/water_reservoirs.png}
&
\card{Solid Infrastructure}{Blessing}{ \small Shield \earth \ against damage that scales with \water \ until the end of your opponent's turn.}{\onecost}{imgs/solid_infrastructure.png}
&
\card{Natural Forests}{Blessing}{ \small Shield \nature \ against damage that scales with \earth \ until the end of your opponent's turn.}{\onecost}{imgs/natural_forests.png}
&
\card{Paid Militia}{Blessing}{ \footnotesize Shield \gold \ against damage that scales with a single element until the end of your opponent's turn.}{\twocost}{imgs/paid_militia.png}
&
\card{Magical Barrier}{Blessing}{ \scriptsize Shield \magic \ against damage that scales with multiple elements until the end of your opponent's turn.}{\twocost}{imgs/magical_barrier.png}
&

\card{Prometheus's Gift}{Spell}{Double the strength of all your cards that scale with \fire \ until the end of your turn.}{\twocost}{imgs/prometheuss_gift.png}
&
\card{Gaia's Favor}{Spell}{Double the strength of all your cards that scale with \earth \ until the end of your turn.}{\twocost}{imgs/gaias_favor.png}
&
\card{Poseidon's Trident}{Spell}{Double the strength of all your cards that scale with \water \ until the end of your turn.}{\twocost}{imgs/poseidons_trident.png}
&
\card{Ancient Grimoire}{Spell}{Double the strength of all your cards that scale with \magic \ until the end of your turn.}{\twocost}{imgs/ancient_grimoire.png}
&
...
&
\card{Midas Touch}{Spell}{Double the strength of all your cards that scale with \gold \ until the end of your turn.}{\twocost}{imgs/midas_touch.png}
&
\card{Purism}{Spell}{ \footnotesize Double the strength of all your cards that scale with a single element until the end of your turn.}{\twocost}{imgs/purism.png}
&
...
&
\card{Madness}{Spell}{Upon buying, reroll all dice and trash this card.}{\onecost}{imgs/madness.png}
&
...
&
\card{All for One}{Blessing}{Up to once during your turn, discard 3 cards from your hand and gain 1 mana.}{\twocost}{imgs/all_for_one.png}
&
...
&
\card{At What Cost}{Relic}{ \footnotesize Upon buying, trash a relic you own; gain 1 extra mana at the start of your turn.}{\fourcost}{imgs/at_what_cost.png}
&
...
&
\card{Well-Laid Plans}{Blessing}{ \small Reorder the top \handsize \ cards of your draw pile and discard any number of them.}{\twocost}{imgs/well_laid_plans.png}
&
\card{Magnetic Hands}{Blessing}{ \small Move any card from your draw pile to your hand and shuffle your draw pile.}{\twocost}{imgs/magnetic_hands.png}
&
...
\card{Optimization Novice}{Spell}{Trash this card and up to 1 card from your hand.}{\onecost}{imgs/optimization_novice.png}
&
\card{Optimization Master}{Spell}{Trash this card and up to 2 cards from your hand.}{\twocost}{imgs/optimization_master.png}
&
\card{Optimization Lord}{Spell}{Trash this card and up to 3 cards from your hand.}{\threecost}{imgs/optimization_lord.png}
&
\card{Optimization God}{Spell}{Trash this card and up to 3 cards from your hand or discard pile.}{\fourcost}{imgs/optimization_god.png}
&
\card{Spring Cleaning}{Spell}{Upon buying, trash this card and up to 1 card from your hand.}{\twocost}{imgs/spring_cleaning.png}
&

\card{Wish}{Spell}{ \footnotesize Buy any unowned card for free and shuffle the shop's draw pile; trash this card after 3 uses.}{\fivecost}{imgs/wish.png}
&
\card{Scout}{Spell}{ \small Upon buying, buy any unowned card, shuffle the shop's draw pile and trash this card.}{\twocost}{imgs/scout.png}
&
...
\card{Veto}{Spell}{Your opponent receives 1 less mana at the start of their next turn.}{\onecost}{imgs/veto.png}
&
...
&
\card{Sabotage}{Blessing}{ \small Reorder the top \handsize \ cards of your opponent's draw pile and discard any number of them.}{\twocost}{imgs/sabotage.png}
&
\card{Curse}{Spell}{ \footnotesize Upon buying, add this card to your opponent's discard pile instead; does nothing afterwards.}{\twocost}{imgs/curse.png}
&
