...
Elemental buffs work similarly to shields in that they double the effective value of their respective elements prior to any scaling calculations.
...
\card{Madness}{Blessing}{ \small Upon buying this, reroll all dice (including \chance) and permanently remove this card.}{\threecost}{imgs/madness.png}
&
...
\card{Veto}{Action}{ \small Cancel the last action or blessing of your opponent and permanently remove this card.}{\threecost}{imgs/veto.png}
&
...
\card{Wish}{Action}{Buy any unowned card in the game for free, then shuffle the shop's draw pile.}{\fivecost}{imgs/wish.png}
&
