...
\newcommand{\cardtextboxheight}{17mm}
\newcommand{\cardsubvaluesheight}{67mm}
\newcommand{\cardboxpadding}{1mm}
...
\node (title) at (0.5 * \cardwidth - \cardboxpadding, \cardheight -
    2 * \cardroundingradius - \cardboxpadding)
    [ fill=\cardtitlecolour!20, draw=\cardtitlecolour, thick,
    text width = \cardwidth - 2* (\cardmargin + \cardroundingradius),
    minimum height = \cardtitletextheight]
    { \Large #1 };

\node (text)
    [ fill=\cardtextboxcolour!20, draw=\cardtextboxcolour, thick,
    below left = \cardimageheight + \cardtitletextheight and 0mm of
    title, anchor = west,
    text width = \cardwidth - 2 * (\cardmargin + \cardroundingradius), text
    depth = \cardtextboxheight - 2 * \cardboxpadding, align=justify]
    { #3 };

\node (value)
    [ fill=\cardvaluecolour!20, draw=\cardvaluecolour, thick,
    below right = \cardsubvaluesheight and 0mm of title, anchor = east]
    { #4 Gold };

\node (type)
    [ fill=\cardtypecolour!20, draw=\cardtypecolour, thick,
    below left = \cardsubvaluesheight and 0mm of title, anchor = west]
    { #2 };
...
% TODO -- Names
\inventory{Ecology 1}{Action}{Heal \nature \ health.}{\onecost}
&
\inventory{Ecology 2}{Action}{Heal $2 \times$\nature \ health.}{\twocost}
&
...
&
\inventory{Treasury 2}{Action}{Gain $2 \times$\gold \ gold.}{\twocost}
&
...
% TODO -- Names for Sleight of Hand
\inventory{Gambling}{Action}{Reroll a die once.}{\onecost}
&
\inventory{Sleight of Hand 1}{Action}{Change the value of a die by one.}{\onecost}
&
\inventory{Second Chance}{Action}{Reroll a die up to twice.}{\twocost}
&
\inventory{Sleight of Hand 2}{Action}{Change the value of a die by up to two.}{\twocost}
&
\inventory{Calculated Risk}{Action}{Reroll a die up to four times.}{\threecost}
&
\inventory{Sleight of Hand 3}{Action}{Change the value of a die by up to three.}{\threecost}
&
...
&
\inventory{Sabotagge}{Action}{Look at and reorder the top \utility \ cards of your opponent's deck.}{\twocost}
&
...
% TODO -- Names
\inventory{Multitasking 1}{Blessing}{Gain $\frac{1}{3} \times$\utility \ actions for the rest of this turn.}{\onecost}
&
\inventory{Multitasking 2}{Blessing}{Gain $\frac{1}{2} \times$\utility \ actions for the rest of this turn.}{\twocost}
&
\inventory{Multitasking 3}{Blessing}{Gain $\frac{2}{3} \times$\utility \ actions for the rest of this turn.}{\threecost}
&
\inventory{Multitasking 4}{Blessing}{Gain \utility \ actions for the rest of this turn}{\fourcost}
&

% TODO -- Names
\inventory{Exploration 1}{Action}{Draw $\frac{1}{3} \times$\utility \ more cards.}{\onecost}
&
\inventory{Exploration 2}{Action}{Draw $\frac{1}{2} \times$\utility \ more cards.}{\twocost}
&
\inventory{Exploration 3}{Action}{Draw $\frac{2}{3} \times$\utility \ more cards.}{\threecost}
&
\inventory{Exploration 4}{Action}{Draw \utility \ more cards.}{\fourcost}
&

% TODO -- Names
\inventory{Recycling 1}{Action}{Remove up to $\frac{1}{3} \times$\utility \ cards from your hand and return them to the card store.}{\onecost}
&
\inventory{Recycling 2}{Action}{Remove up to $\frac{1}{2} \times$\utility \ cards from your hand and return them to the card store.}{\twocost}
&
\inventory{Recycling 3}{Action}{Remove up to $\frac{2}{3} \times$\utility \ cards from your hand and return them to the card store.}{\threecost}
&
\inventory{Recycling 4}{Action}{Remove up to \utility \ cards from your hand and return them to the card store.}{\fourcost}
&
