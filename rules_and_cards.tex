...
\newcommand{\cardtextheight}{15.6mm}
...
\newcommand{\cardimgheight}{42.1mm}
\newcommand{\cardimghalfwidth}{25.4mm}
\newcommand{\cardimghalfheight}{21.05mm}
...
&
\card{Massive Earthquake}{Action}{Deal $2 \times$\earth \ damage to your opponent.}{\threecost}{imgs/massive_earthquake.png}
&
\card{Torrential Rainstorm}{Action}{Deal $2 \times$\water \ damage to both yourself and your opponent.}{\threecost}{imgs/torrential_rainstorm.png}
&
\card{Haphazard Offence}{Action}{Deal $2 \times$\chance \ to your opponent.}{\threecost}{imgs/haphazard_offence.png}
&
\card{Lava Surge}{Action}{Deal \fire$+$\earth \ damage to your opponent.}{\threecost}{imgs/lava_surge.png}
&
\card{Erratic Blaze}{Action}{Deal \fire$+$\chance \ damage to your opponent.}{\threecost}{imgs/erratic_blaze.png}
&
\card{Chaotic Avalanche}{Action}{Deal \earth$+$\chance \ damage to your opponent.}{\threecost}{imgs/chaotic_avalanche.png}
&
\card{Scalding Fog}{Action}{Deal \water$+$\fire \ damage to both yourself and your opponent.}{\threecost}{imgs/scalding_fog.png}
&
\card{Devastating Mudslide}{Action}{Deal \water$+$\earth \ damage to both yourself and your opponent.}{\threecost}{imgs/devastating_mudslide.png}
&
\card{Wild Seas}{Action}{Deal \water$+$\chance \ damage to both yourself and your opponent.}{\threecost}{imgs/wild_seas.png}
&
\card{Magical Inferno}{Action}{Deal \fire$\times$\magic \ damage to your opponent.}{\fourcost}{imgs/magical_inferno.png}
&
\card{Arcane Meteor}{Action}{Deal \earth$\times$\magic \ damage to your opponent.}{\fourcost}{imgs/arcane_meteor.png}
&
\card{Biblical Flood}{Action}{Deal \water$\times$\magic \ damage to both yourself and your opponent.}{\fourcost}{imgs/biblical_flood.png}
&
\card{Ethereal Havoc}{Action}{Deal \chance$\times$\magic \ damage to your opponent.}{\fourcost}{imgs/ethereal_havoc.png}
&

\card{Flower Gardens}{Action}{Restore \nature \ HP.}{\onecost}{imgs/flower_gardens.png}
&
\card{Lush Forests}{Action}{Restore $2 \times$\nature \ HP.}{\twocost}{imgs/lush_forests.png}
&
\card{Fertile Soils}{Action}{Restore \nature$+$\earth \ HP.}{\twocost}{imgs/fertile_soils.png}
&
\card{Hot Springs}{Action}{Restore \nature$+$\water \ HP.}{\twocost}{imgs/hot_springs.png}
& 
\card{Clover Fields}{Action}{Restore \nature$+$\chance \ HP.}{\twocost}{imgs/clover_fields.png}
&
\card{Mystical Restoration}{Action}{Restore \nature$\times$\magic \ HP.}{\threecost}{imgs/mystical_restoration.png}
&

\card{Marketplace}{Action}{Gain \gold \ gold.}{\onecost}{imgs/marketplace.png}
&
\card{Treasury}{Action}{Gain $2 \times$\gold \ gold.}{\twocost}{imgs/treasury.png}
&
\card{Gold Mine}{Action}{Gain \gold$+$\earth \ gold.}{\twocost}{imgs/gold_mine.png}
&
\card{Gold Panning}{Action}{Gain \gold$+$\water \ gold.}{\twocost}{imgs/gold_panning.png}
&
\card{Free Market}{Action}{Gain \gold$+$\chance \ gold.}{\twocost}{imgs/free_market.png}
&
\card{Ancient Alchemy}{Action}{Gain \gold$\times$\magic \ gold.}{\threecost}{imgs/ancient_alchemy.png}
&

\card{Water Reservoirs}{Action}{Shield \water \ against \fire \ damage until the end of your opponent's turn.}{\onecost}{}
&
\card{Solid Infrastructure}{Action}{Shield \earth \ against \water \ damage until the end of your opponent's turn.}{\onecost}{}
&
\card{Natural Forests}{Action}{Shield \nature \ against \earth \ damage until the end of your opponent's turn.}{\onecost}{}
&
\card{Magical Barrier}{Action}{Shield \magic \ against multi-element damage until the end of your opponent's turn.}{\twocost}{}
&
\card{Paid Militia}{Action}{\small Shield any damage by paying one gold per damage until the end of your opponent's turn.}{\twocost}{}
&
...
&
\card{Sneak Peek}{Blessing}{Draw a card and look at the top \handsize \ cards of your draw pile.}{\onecost}{}
&
\card{Reconnaissance}{Blessing}{Draw a card and look at the top \handsize \ cards of your opponent's draw pile.}{\onecost}{}
&
\card{Forecast}{Blessing}{Draw a card and look at the top \shopsize \ cards of the shop's draw pile.}{\onecost}{}
&

\card{Impatience}{Action}{Reorder your draw pile.}{\twocost}{}
&
\card{Sabotage}{Action}{Reorder your opponent's draw pile.}{\twocost}{}
&
\card{Magnetic Hands}{Action}{ \small Move any card from your draw or discard pile to your hand, then shuffle your draw pile.}{\twocost}{}
&
...
&
\card{Cruel Pact}{Blessing}{Take \chance \ damage and play up to 1 extra action.}{\onecost}{}
&
\card{Deal with the Devil}{Blessing}{Take $2\times$\chance \ damage and play up to 2 extra actions.}{\onecost}{}
&
...
\card{Optimization Novice}{Action}{Permanently remove up to 1 card from your hand.}{\onecost}{}
&
\card{Optimization Master}{Action}{Permanently remove up to 2 cards from your hand.}{\twocost}{}
&
\card{Optimization Lord}{Action}{Permanently remove up to 3 cards from your hand or this card.}{\threecost}{}
&
\card{Optimization God}{Action}{Permanently remove up to 4 cards from your hand, discard pile or this card.}{\fourcost}{}
&

\card{Wish}{Action}{Buy any avaliable card in the game for free, then shuffle the shop's draw pile.}{\fivecost}{}
&

\card{Deep Pockets}{Passive}{You may reroll the shop and buy cards an unlimited number of times per turn.}{\twocost}{}
&
\card{Express Shipping}{Passive}{All cards you buy go into your hand.}{\threecost}{}
&
\card{Reroller}{Passive}{Shop rerolls cost 1 gold less.}{\threecost}{}
&
\card{Big Handed}{Passive}{Draw 1 extra card after your turn.}{\fourcost}{}
&
\card{Spacious Table}{Passive}{You have space for 1 extra face down card.}{\threecost}{}
&
\card{Cheapskate}{Passive}{Face down cards no longer cost gold to play.}{\threecost}{}
&
\card{Proactive}{Passive}{Play up to 1 extra action per turn, but draw 1 card less after your turn.}{\fourcost}{}
&
\card{At What Cost}{Passive}{ \small Permanently remove a passive card upon buying this; play up to 1 extra action per turn.}{\fourcost}{}
&
