...
&
\card{Magical Firestorm}{Action}{Deal \fire$\times$\magic \ damage to your opponent.}{\fourcost}
&
\card{Meteor Strike}{Action}{Deal \earth$\times$\magic \ damage to your opponent.}{\fourcost}
&
\card{Biblical Flood}{Action}{Deal \water$\times$\magic \ damage to both yourself and  your opponent.}{\fourcost}
&
...
&
\card{Nature Reserves}{Action}{Heal \earth$\times$\nature \ health.}{\threecost}
&
\card{Hot Springs}{Action}{Heal \water$\times$\nature \ health.}{\threecost}
&
\card{Mystical Restoration}{Action}{Heal \magic$\times$\nature \ health.}{\threecost}
& 
...
&
\card{Gold Mine}{Action}{Gain \earth$\times$\gold \ gold.}{\threecost}
&
\card{Gold Panning}{Action}{Gain \water$\times$\gold \ gold.}{\threecost}
&
...
&
\card{Truly Blessed}{Passive}{Draw a card each time you play a blessing but you may no longer draw cards from active effects.}{\fourcost}
&
