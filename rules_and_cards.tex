...
A player's hand, face down cards, discard pile and discards and are private information, i.e. they may see them, but the other player cannot. A player's draw pile and the shop's draw pile are hidden information, i.e. nobody can see them. The laid out shop, the shop's discard pile, the removed cards pile, a player's played cards, bought cards, removed cards, gold, HP, mana and all counts (i.e. number of discarded cards, face down cards, cards in their hand, draw pile or discard pile) are all public information, i.e. both players can see them.
